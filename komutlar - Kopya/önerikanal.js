...
exports.run = (client, message, args) => { 
  ...
  if(!kanal) return message.reply(':x: Bu Özelliği Ayarlamam İçin Bir Kanal Etiketlemelisin Örnek: `v!öneri-kanal-ayarla #kanal`')
  
  message.channel.send('Öneri  Kanalını Basarılı Sekilde Ayarladım.')

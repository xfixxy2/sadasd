...
exports.run = async (client, message) => {
  if(message.author.id !== "735555273644703915") if(message.author.id !== "") return message.channel.send("Sahibimmisin hayır ne deniyon");
...
exports.help = {
name: "amınısikeyimorospusununndasndasnadsjjadsjadsjadsjasdj",
